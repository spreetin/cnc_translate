...
MachineParameters TraubTX8H_definition::getParameters() {
  ...
  param.parameter.defaults['I'] = param_undefined;
  param.parameter.defaults['J'] = param_undefined;
  param.parameter.defaults['K'] = param_undefined;
  ...
  // Functions
  param.functions.unary = {
      {"SQR", f_square_root}, {"SIN", f_sine},       {"COS", f_cosine},
      {"TAN", f_tangent},     {"ATN", f_arctangent}, {"RND", f_round},
      {"FUP", f_ceil},        {"FIX", f_floor},      {"GOTO", f_jump},
      {"IF", f_if},           {"ACOS", f_arccosine}, {"LN", f_ln}};
  param.functions.binary = {{"EQ", f_comparison_equal},
                            {"NE", f_comparison_not_equal},
                            {"GT", f_comparison_greater},
                            {"LT", f_comparison_lesser},
                            {"GE", f_comparison_greater_eq},
                            {"LE", f_comparsion_lesser_eq},
                            {"OR", f_or_b},
                            {"AND", f_and_b},
                            {"XOR", f_xor_b},
                            {"MOD", f_mod}};
  ...
  param.g[g_rapid_positioning] = {0,
                                  gmode_motion, // + C
                                  {'X', 'Z', 'U', 'W', 'F', 'S', 'T'}};
  param.g[g_linear_interpolation] = {
      1,
      gmode_motion, // + C
      {'X', 'Z', 'U', 'W', 'A', 'D', 'R', 'E', 'S', 'T'},
      {{'A', param_angle}, {'E', param_transfer_feed}}};
  param.g[g_circular_interpolation_cw] = {
      2,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'I', 'K', 'P', 'Q', 'R', 'D', 'C', 'H', 'F', 'E',
       'S', 'T'},
  ...
  param.g[g_circular_interpolation_ccw] = {
      3,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'I', 'K', 'P', 'Q', 'R', 'D', 'C', 'H', 'F', 'E',
       'S', 'T'},
  ...
  param.g[g_linear_interpolation_with_collision_stop] = {
      8,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'A', 'D', 'R', 'E', 'S', 'T'},
      {{'A', param_angle}, {'E', param_transfer_feed}}};
  param.g[g_linear_interpolation_with_feed_reduction] = {
      9,
      gmode_motion,
  ...
  param.g[g_dimension_input_inch] = {20, gmode_nonmodal, {'S'}};
  param.g[g_dimension_input_metric] = {21, gmode_nonmodal, {'S'}};
  param.g[g_load_subprogram] = {22,
                                gmode_nonmodal,
                                {'A', 'P', 'Q', 'H'},
                                {{'A', param_subprogram},
  ...
  param.g[g_rapid_direct_to_reference] = {28,
                                          gmode_motion,
                                          {'X', 'Z', 'U', 'W', 'C', 'S'},
                                          {{'X', param_help_x},
                                           {'Z', param_help_z},
                                           ...
                                           {'W', param_help_w},
                                           {'C', param_c_axis}}};
  param.g[g_thread_cutting_constant_lead] = {
      33,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'F', 'E'},
      {{'F', param_thread_lead_3decimals}, {'E', param_thread_lead_5decimals}}};
  param.g[g_thread_cutting_variable_lead] = {
      34,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'F', 'E', 'K'},
  ...
  param.g[g_rapid_relative_to_reference] = {53, gmode_motion, {'X', 'Z', 'S'}};
  ...
  param.g[g_cutting_cycle_convex_tool_x] = {
      70,
      gmode_motion,
      {'A', 'P', 'Q', 'I', 'K', 'D', 'J', 'F', 'S'},
      {{'A', param_subprogram},
       ...
       {'J', param_tool_angle}}};
  param.g[g_cutting_cycle_concave_tool_x] = {
      71,
      gmode_motion,
      {'A', 'P', 'Q', 'I', 'K', 'D', 'F', 'E', 'S'},
      {{'A', param_subprogram},
  ...
  param.g[g_cutting_cycle_z] = {72,
                                ...
                                {{'A', param_subprogram},
                                 ...
                                 {'D', param_margin_cutting_depth},
                                 {'E', param_feed_downwards}}};
  param.g[g_cutting_cycle_same_contour] = {
      73,
      gmode_motion,
  ...
  param.g[g_cutting_cycle_straight_with_fallback] = {
      74,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'I', 'K', 'D', 'F'},
  ...
  param.g[g_cutting_cycle_straight_with_fallback_z] = {
      75,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'I', 'K', 'D', 'F'},
      {{'K', param_distance_before_fallback},
       {'D', param_fallback_distance},
       {'I', param_margin_cutting_depth}}};
  param.g[g_thread_cutting_cycle] = {
      76,
      gmode_motion,
  ...
  param.g[g_thread_cutting_end_face] = {
      86,
      gmode_motion,
      {'X', 'Z', 'U', 'W', 'I', 'J', 'K', 'H', 'F', 'E', 'A', 'D'},
      {{'I', param_conical_amount},
  ...
  param.g[g_rpm_limit] = {
      92, -1, {'S', 'Q'}, {{'S', param_rpm_max}, {'Q', param_rpm_min}}};
  param.g[g_feed_per_minute] = {
      94, gmode_feed_rate, {'S'}, {{'S', param_rpm_or_feed}}};
  param.g[g_feed_per_revolution] = {
      95, gmode_feed_rate, {'S'}, {{'S', param_rpm_or_feed}}};
  param.g[g_constant_surface_speed] = {
      96, gmode_spindle_speed, {'V', 'T'}, {{'V', param_feed}}};
  param.g[g_revolutions_per_minute] = {
      97,
      gmode_spindle_speed,
      {'S', 'V', 'X', 'T'},
      {{'X', param_diameter}, {'V', param_feed}}};
  param.g[g_feed_correction] = {98, gmode_feed_rate, {'S'}, {{'S', param_rpm}}};
  param.g[g_feed_correction_off] = {
      99, gmode_feed_rate, {'S'}, {{'S', param_rpm}}};
  ...
  // 387 - Gängskärningscykel för gängtapp eller gängsnitt med fast hållare
  // (synkroniserad)
